...
public class ContainerShrine extends Container
{
    ...
    public ContainerShrine(InventoryPlayer playerInv, World worldIn)
    {
        this(playerInv, worldIn, BlockPos.ORIGIN);
    }

    public ContainerShrine(InventoryPlayer playerInv, World worldIn, BlockPos pos)
    {
        this.tableInventory = new InventoryBasic("Shrine", true, 2)
        {
            /**
