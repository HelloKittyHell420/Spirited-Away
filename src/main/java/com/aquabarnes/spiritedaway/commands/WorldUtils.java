...
public class WorldUtils extends Teleporter {

    public WorldUtils(WorldServer world, double x, double y, double z) {
        super(world);
    ...
    public static void teleportToDimension(EntityPlayer player, int dimension, double x, double y, double z) {
        ...
        worldServer.getMinecraftServer().getPlayerList().transferPlayerToDimension(entityPlayerMP, dimension, new WorldUtils(worldServer, x, y, z));
