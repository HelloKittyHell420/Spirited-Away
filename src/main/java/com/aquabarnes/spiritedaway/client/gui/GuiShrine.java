...
public class GuiShrine extends GuiContainer
{
    ...
    private static final ModelHakuHuman MODEL_HAKU = new ModelHakuHuman(); //80 Days Worship Dragon
    private static final ModelChihiro MODEL_CHIRHIRO = new ModelChihiro(); //Worship ???
    private static final ModelNoFace MODEL_NOFACE = new ModelNoFace(); //Worship Gold Finder
    ...
    public GuiShrine(InventoryPlayer inventory, World worldIn, IWorldNameable nameable)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        MODEL_NOFACE.render((Entity)null, 0.0F, f3, f4, f2, 0.0F, 0.0625F);
