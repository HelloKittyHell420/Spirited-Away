...
import com.aquabarnes.spiritedaway.enums.EnumBedColor;
...
private static final String[] bedTypes = new String[] {"white", "orange", "magenta", "lightblue", "yellow", "lime", "pink", "gray", "lightgray", "cyan", "purple", "blue", "brown", "green", "black"};

public ItemBed(String name)
{
  this.setCreativeTab(SACreativeTabs.tabSADecorations);
...
public String getUnlocalizedName(ItemStack stack)
{
    ...
    if (i < 0 || i >= bedTypes.length)
    {
        i = 0;
    }

    return super.getUnlocalizedName() + "_" + bedTypes[i];
...
public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
{
    ...
    else
    {
        ...
        if (playerIn.canPlayerEdit(pos, facing, stack) && playerIn.canPlayerEdit(blockpos, facing, stack))
        {
            ...
            {
                IBlockState iblockstate1 = bedTypes().getDefaultState().withProperty(BlockBed.OCCUPIED, Boolean.valueOf(false)).withProperty(BlockBed.FACING, enumfacing).withProperty(BlockBed.PART, BlockBed.EnumPartType.FOOT);
