...
public class BlockPressurePlate extends BlockBasePressurePlate {
		 ...
		 private final BlockPressurePlate.Sensitivity sensitivity;
		    ...
		    public BlockPressurePlate(String name, Material materialIn, BlockPressurePlate.Sensitivity sensitivityIn)
		    {
		        super(materialIn);
		    ...
		    protected void playClickOnSound(World worldIn, BlockPos color)
		    {
		        ...
		        {
		            worldIn.playSound((EntityPlayer)null, color, SoundEvents.BLOCK_WOOD_PRESSPLATE_CLICK_ON, SoundCategory.BLOCKS, 0.3F, 0.6F);
		        }
		    }
		    ...
		    protected void playClickOffSound(World worldIn, BlockPos pos)
		    {
		        ...
		        {
		            worldIn.playSound((EntityPlayer)null, pos, SoundEvents.BLOCK_WOOD_PRESSPLATE_CLICK_OFF, SoundCategory.BLOCKS, 0.3F, 0.5F);
		        }
		    }
