package com.aquabarnes.spiritedaway.block.biomes;
...
public class BiomeGenSAMesa extends BiomeGenBase
{
    ...
    public BiomeGenSAMesa(boolean p_i46704_1_, boolean p_i46704_2_, BiomeGenBase.BiomeProperties properties)
    {
        super(properties);
