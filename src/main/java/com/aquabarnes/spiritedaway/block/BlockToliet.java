...
public class BlockToliet extends Block {
    ...
    public BlockToliet(Material material)
    {
        super(Material.wood); 
        setUnlocalizedName("toliet");
        setRegistryName("toliet");     
    ...
    {
        return new ItemStack(SABlocks.TOLIET);
    }
