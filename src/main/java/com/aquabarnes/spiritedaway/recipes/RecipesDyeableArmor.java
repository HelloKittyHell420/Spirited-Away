...
public class RecipesDyeableArmor implements IRecipe
{
    /**
    ...
    public boolean matches(InventoryCrafting inv, World worldIn)
    {
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i)
        {
            ...
            if (itemstack1 != null)
            {
                ...
                {
                    ItemArmorDyeable itemarmor = (ItemArmorDyeable)itemstack1.getItem();
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv)
    {
        ...
        int i = 0;
        int j = 0;
        ItemArmorDyeable itemarmor = null;
        ...
        for (int k = 0; k < inv.getSizeInventory(); ++k)
        {
            ...
            if (itemstack1 != null)
            {
                if (itemstack1.getItem() instanceof ItemArmorDyeable)
                {
                    itemarmor = (ItemArmorDyeable)itemstack1.getItem();
