...
public class BlockSkull extends BlockContainer
{
    ...
    private static final Predicate<BlockWorldState> IS_WITHER_SKELETON = new Predicate<BlockWorldState>()
    {
        ...
        {
        	return p_apply_1_.getBlockState() != null && p_apply_1_.getBlockState().getBlock() == SAItemBlocks.SKULL && p_apply_1_.getTileEntity() instanceof TileEntitySkull && ((TileEntitySkull)p_apply_1_.getTileEntity()).getSkullType() == 1;
        }
    };
    ...
    public BlockSkull()
    {
        ...
        GameRegistry.register(new ItemBlockSkull(this), getRegistryName());
    }
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        return new ItemStack(SAItemBlocks.SKULL, 1, i);
    }
    ...
    {
        return null; //SAItemBlocks.SKULL;
    }
