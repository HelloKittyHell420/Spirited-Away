	            ...
	            for (int j1 = -2; j1 <= 2; ++j1)
	            {
	                for (int k1 = -2; k1 <= 2; ++k1)
	                {
	                    for (int l1 = -1; l1 < 3; ++l1)
	                    {
	                        ...
	                        int k2 = k + k1 * i1 - j1 * l;
	                        boolean flag = l1 < 0;
	                        this.worldServerInstance.setBlockState(new BlockPos(i2, j2, k2), flag ? Blocks.snow.getDefaultState() : Blocks.air.getDefaultState());
	                    }
	                }
	            }
	            ...
	            for (int j7 = -1; j7 <= 1; ++j7)
	            {
	                for (int l7 = 1; l7 < 3; ++l7)
	                {
	                    for (int k8 = -1; k8 < 3; ++k8)
	                    {
	                        ...
	                        boolean flag = k8 < 0;
	                        this.worldServerInstance.setBlockState(new BlockPos(k9, k10, k11), flag ? Blocks.snow.getDefaultState() : Blocks.air.getDefaultState());
	                    }
	                }
	            }
	        }
	        ...
	        for (int i8 = 0; i8 < 4; ++i8)
	        {
	            for (int l8 = 0; l8 < 4; ++l8)
	            {
	                for (int l9 = -1; l9 < 4; ++l9)
	                {
	                    ...
	                    this.worldServerInstance.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.snow.getDefaultState() : iblockstate, 2);
	                }
	            }
